...
new_left_content = """        <div class="left-content">
...
# Replace everything from <div class="left-content"> to </div> right before <div class="right-fixed">
pattern = re.compile(r'<div class="left-content">.*?</section>\s*</div>', re.DOTALL)
new_content = pattern.sub(new_left_content, content)
